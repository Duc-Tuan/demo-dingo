        ...
        <div className="container box_1170">
          <div className="section-top-border">
            ...
            <div className="row">
              <div className="col-md-3">
                <img src="https://raw.githubusercontent.com/Duc-Tuan/img_dingo/main/elements/d.jpg" alt="..." className="img-fluid" />
              </div>
                  ...
                  return (
                    <div className="table-row" key={data.id}>
                      ...
                      <div className="country">
                        {" "}
                        <img src={data.imagSrc} alt="flag" />
                        {data.name}
                      </div>
                      <div className="visit">{data.visits}</div>
                      <div className="percentage">
                        <div className="progress">
                          <div
                            className={`progress-bar color-${data.id}`}
                            role="progressbar"
                            style={{ width: `${data.percentages}%` }}
                            aria-valuenow="80"
                            aria-valuemin="0"
                            aria-valuemax="100"
                          ></div>
          ...
          <div className="section-top-border">
            ...
            <div className="row gallery-item">
              {data_food_element.map((data) => {
                return (
                  <div className={`col-md-${data.pillar}`} key={data.id}>
                    <Link href={data.href}>
                      <a className="img-pop-up">
                        <div
              ...
              <div className="col-lg-8 col-md-8">
                ...
                <form action="#">
                  ...
                  <div className="input-group-icon mt-10">
                    ...
                    <div className="form-select-city" id="default-select">
                      <select>
                  ...
                  <div className="input-group-icon mt-10">
                    ...
                    <div className="form-select-country" id="default-select">
                      <select>
              ...
              <div className="col-lg-3 col-md-4 mt-sm-30">
                <div className="single-element-widget">
                  ...
                  <div className="switch-wrap d-flex justify-content-between">
                    ...
                    <div className="primary-switch">
                      <input type="checkbox" id="primary-switch" readOnly />
                  ...
                  <div className="switch-wrap d-flex justify-content-between">
                    ...
                    <div className="confirm-switch">
                      <input type="checkbox" id="confirm-switch" readOnly />
                ...
                <div className="single-element-widget mt-30">
                  ...
                  <div className="default-select-language" id="default-select">
                    <select>
                ...
                <div className="single-element-widget mt-30">
                  ...
                  <div className="switch-wrap d-flex justify-content-between">
                    ...
                    <div className="primary-checkbox">
                      <input type="checkbox" id="primary-checkbox" readOnly />
                ...
                <div className="single-element-widget mt-30">
                  ...
                  <div className="switch-wrap d-flex justify-content-between">
                    ...
                    <div className="primary-radio">
                      <input type="checkbox" id="primary-radio" readOnly />
                  ...
                  <div className="switch-wrap d-flex justify-content-between">
                    ...
                    <div className="confirm-radio">
                      <input type="checkbox" id="confirm-radio" readOnly />
