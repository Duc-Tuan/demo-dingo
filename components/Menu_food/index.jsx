            ...
            <div className="col-lg-6">
              ...
              >
                <a
                  ...
                  aria-selected="false"
                >
                  Special <img src="/images/icon/play.svg" alt="play" />
                </a>
                <a
                  id="Breakfast-tab"
                  data-toggle="tab"
                  ...
                  aria-selected="false"
                >
                  Breakfast <img src="/images/icon/play.svg" alt="play" />
                </a>
                <a
                  id="Launch-tab"
                  data-toggle="tab"
                  ...
                  aria-selected="false"
                >
                  Launch <img src="/images/icon/play.svg" alt="play" />
                </a>
                <a
                  id="Dinner-tab"
                  data-toggle="tab"
                  ...
                  aria-selected="false"
                >
                  Dinner <img src="/images/icon/play.svg" alt="play" />{" "}
                </a>
                <a
                  id="Sneaks-tab"
                  data-toggle="tab"
                  ...
                  aria-selected="false"
                >
                  Sneaks <img src="/images/icon/play.svg" alt="play" />
                </a>
              </div>
            </div>
                  ...
                  <div className="row">
                    <div className="col-sm-6 col-lg-6">
                      <div className="single_food_item media">
                        <img
                          src="/images/food_menu/single_food_1.png"
                          className="mr-3"
                          alt="..."
                        />
                      ...
                      <div className="single_food_item media">
                        <img
                          src="/images/food_menu/single_food_2.png"
                          className="mr-3"
                          alt="..."
                        />
                        <div className="media-body align-self-center">
                      ...
                      <div className="single_food_item media">
                        <img
                          src="/images/food_menu/single_food_3.png"
                          className="mr-3"
                          alt="..."
                        />
                        <div className="media-body align-self-center">
                    ...
                    <div className="col-sm-6 col-lg-6">
                      <div className="single_food_item media">
                        <img
                          src="/images/food_menu/single_food_4.png"
                          className="mr-3"
                          alt="..."
                        />
                        <div className="media-body align-self-center">
                      ...
                      <div className="single_food_item media">
                        <img
                          src="/images/food_menu/single_food_5.png"
                          className="mr-3"
                          alt="..."
                        />
                        <div className="media-body align-self-center">
                      ...
                      <div className="single_food_item media">
                        <img
                          src="/images/food_menu/single_food_6.png"
                          className="mr-3"
                          alt="..."
                        />
                        <div className="media-body align-self-center">
